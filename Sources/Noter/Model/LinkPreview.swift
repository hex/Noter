...
struct LinkPreview: Codable, Equatable, Sendable {
    ...
    static func usesOEmbed(_ url: URL) -> Bool { site(for: url) == .x }
    ...
    static func withoutSitePrefix(_ title: String, site: String?) -> String {
    ...
    static func parseGitHubRepo(_ data: Data, url: URL) throws -> LinkPreview {
    ...
    static func parseGitHubIssue(_ data: Data, url: URL) throws -> LinkPreview {
    ...
    static func parseRedditOEmbed(_ data: Data, url: URL) throws -> LinkPreview {
    ...
    static func parseYouTubeOEmbed(_ data: Data, url: URL) throws -> LinkPreview {
    ...
    static func parseHackerNews(_ data: Data, url: URL) throws -> LinkPreview {
    ...
    static func anchorTexts(in html: String) -> [String] {
    ...
    static func plainMarkdown(_ body: String) -> String {
